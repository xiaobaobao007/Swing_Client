...
public class TeamPeople implements Runnable {
	...
	private final int smap_x = 937;// 小地图位置
	private final int smap_y = 20;// 小地图位置
	private final List<HurtBlood> hurtBloods;// 伤害提示
	...
	private final String own_weapon_special_string = "resouce/image/specials/special4/special";// 人物武器图片
	...
	private final int full_blood;// 满血==
	private final int blood;// 当前血量
	private final int full_magic;// 满蓝==
	private final int magic;// 当前蓝量
	private final boolean alive = true;// 存活
	private final int direct = 1;// 方向
	private int people;// 人物id
	private final int run_state = 1;// 奔跑状态
	private final int move = 1;// 移动状态
